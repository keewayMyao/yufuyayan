  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <el-form-item prop="invitationCode">
        ...
        <el-input ref="invitationCode" v-model="loginForm.invitationCode" placeholder="邀请码" name="invitationCode" type="text"
                  tabindex="1" auto-complete="on" />
      </el-form-item>

      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click="poshRegister">注册</el-button>
